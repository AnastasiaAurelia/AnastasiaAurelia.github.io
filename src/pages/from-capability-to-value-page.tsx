...
const toc = sections.map((section) => ({
  id: section.id,
  // Chapters get "01"…; parts and appendices keep their numeral or letter.
  number: section.eyebrow
    ...
    : '',
  division: Boolean(section.eyebrow && !section.eyebrow.startsWith('Chapter ')),
  title: section.title,
}))
    ...
    <>
        ...
        jsonLd={[
          {
            ...
            alternativeHeadline: CAPABILITY_VALUE_SUBTITLE,
            description: SUMMARY.excerpt,
      ...
      <article ref={articleRef} className="container-editorial section-y-tight pt-14">
        ...
        <header className="max-w-3xl">
          <p className="label-mono text-accent">{SUMMARY.category} · AI systems</p>
          <h1 className="mt-3 text-4xl leading-tight sm:text-5xl">{SUMMARY.title}</h1>
          <p className="mt-5 font-serif text-2xl leading-snug text-ink-muted sm:text-3xl">{CAPABILITY_VALUE_SUBTITLE}</p>
        ...
        <div className="mt-12 grid gap-12 border-t border-line pt-12 lg:grid-cols-[15rem_minmax(0,1fr)] lg:gap-16">
          ...
          <div className="long-form min-w-0 [overflow-wrap:anywhere] [&_table]:[overflow-wrap:normal] [&_th:first-child]:min-w-16">
