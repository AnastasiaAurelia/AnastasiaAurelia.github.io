...
export function Hero({ headline, supportingCopy, credibilityPoints }: HeroProps) {
  return (
    <section className="container-editorial section-y-tight pt-14 sm:pt-20">
      {/* Asymmetric two-column composition at lg+: copy left, the
          instrument panel right. Below lg the columns simply stack in
          DOM order (instrument after the CTA row), so the hero reads
          exactly as before — complete — with the instrument removed or
          absent. */}
